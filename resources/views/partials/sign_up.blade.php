<div id="signup_div">
    <form id="registration_form" name="registration_form" method="POST" action="{{url("/register")}}"  onsubmit="return signUp();">
        ...
        <table class="table_registration" id="table_signup" >
            ...
            <tr>
                @csrf
                <td><input type="text" name="first_name" id="first_name" placeholder="First name"/>
